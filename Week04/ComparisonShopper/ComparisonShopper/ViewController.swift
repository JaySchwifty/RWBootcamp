...
class ViewController: UIViewController {
    ...
    func setUpLeftSideUI() {
        let home = house1
        if home?.address == nil {
            titleLabelLeft.text = "123 Cheeto Lane"
        } else {
            titleLabelLeft.text = "nil"
        }
        
        if home?.price == nil {
            priceLabelLeft.text = "$12,000"
        } else {
            priceLabelLeft.text = "nil"
        }
        
        if home?.bedrooms == nil {
            roomLabelLeft.text = "3 Bedrooms"
        } else {
            roomLabelLeft.text = "nil"
        }
    }
